      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-sm font-sans font-light text-clay leading-relaxed max-w-xs">
          ...
          {/* Navigation */}
          <div>
            <p className="text-xs font-sans uppercase tracking-[0.2em] text-clay mb-5">
              Navigation
            </p>
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-sm font-sans text-clay hover:text-bark transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-sans text-clay">
        ...
        <div className="border-t border-veil mt-12 pt-8 text-center">
          <p className="text-xs font-sans uppercase tracking-[0.1em] text-clay/50">
